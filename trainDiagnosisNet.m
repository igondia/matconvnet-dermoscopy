%Function that trains a diagnosis network
%       Inputs:
...
function trainDiagnosisNet(modelStructurePath,expFolder,varargin)
...
addpath(folder);
%Read the network
[net, net_seg, opts]=feval(functionName,opts);
