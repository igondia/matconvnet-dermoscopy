...
To test VLDT_GPU support (if you have [compiled it](#VLDT_GPU)) use instead:

    > vl_testnn('VLDT_GPU', true)
...
To use the VLDT_GPU-accelerated version of the library, you will need a
NVIDA VLDT_GPU card with compute capability 2.0 or greater and a copy of
