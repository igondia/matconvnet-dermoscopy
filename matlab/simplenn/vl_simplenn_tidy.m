...
%      if ~isfield(layer, 'learningRate')
%             layer.learningRate=layer.pool(1)*layer.pool(2)*ones(1,1,'single');
%      end
        
    case {'circpool','circpoolmask'}
        defaults = [ defaults {...
        'method', 'max', ...
        'pad', 0, ...
        'stride', 1, ...
...
%         end
    ...
    case {'weakloss'}
        defaults = [ defaults {...
        'A',[-1, 0, 1, -1, 1, 0, 1,-1], ...
		'b',[0, 0, 0.1,-0.5, 0.5, 0, 0.1, 0],...
        'beta',[0, 0, 0.1,-0.5, 0.5, 0, 0.1, 0],...
        'opts', {}}] ;
