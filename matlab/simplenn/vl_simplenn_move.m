...
%VL_SIMPLENN_MOVE  Move a SimpleNN network between CPU and VLDT_GPU.
%   NET = VL_SIMPLENN_MOVE(NET, 'VLDT_GPU') moves the network to the
%   current VLDT_GPU device. NET = VL_SIMPLENN_MOVE(NET, 'cpu') moves the
%   network to the CPU.
%
