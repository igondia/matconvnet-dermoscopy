// @file   bnorm_gpu.cu
// @brief  Batch normalization implementation (VLDT_GPU)
...
/*
 ...
 Summing over plens efficiently over planes is a little complex on the VLDT_GPU.
 ...
 * Warps (up to 32 threads). Highly coupled, and in fact *coalesced* and 
 run essentially in a single stream of vector instructions on the VLDT_GPU, 
