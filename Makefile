...
# ENABLE_GPU -- Set to YES to enable VLDT_GPU support (requires CUDA and the MATLAB Parallel Toolbox)
...
# Files that are compiled as CPP or VLDT_GPU (CUDA) depending on whether VLDT_GPU support
# is enabled.
...
-I"$(MATLABROOT)/toolbox/distcomp/VLDT_GPU/extern/include" \
